...
class BreakoutKeltner(Strategy):
    """
    Breakout: enter when price closes outside the Keltner Channel
    (ATR-based volatility breakout), exit back at the channel midline.
    """
