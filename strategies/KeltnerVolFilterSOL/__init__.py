...
class KeltnerVolFilterSOL(Strategy):
    """
    KeltnerBreakoutVolFilter's entry+filter (best OOS consistency found
    so far: 2/4 folds >1.5, never catastrophic) applied to SOL-USD,
    which showed the strongest raw entry signal of the three symbols
    tested (Stage 1 IS Sharpe 0.84, best annualized return).
    """
