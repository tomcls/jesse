...
class KeltnerLongOnlyVolFilter(Strategy):
    """
    Long-only Keltner breakout with volatility-regime filter. Wave 3's
    KeltnerBreakoutVolFilter showed longs consistently outperforming
    shorts (win rate ~0.13-0.50 longs vs ~0.23-0.27 shorts across all 4
    OOS folds) - this drops the short side entirely to test whether
    removing the weaker leg lifts the combined Sharpe over the bar.
    """
