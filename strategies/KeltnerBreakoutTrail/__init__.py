...
class KeltnerBreakoutTrail(Strategy):
    """
    Keltner channel breakout with an ATR trailing stop instead of
    exit-at-midline (materially different risk management from the
    original BreakoutKeltner, which came closest to passing wave 1's
    walk-forward but fell short in 2 of 4 OOS folds).
    """
